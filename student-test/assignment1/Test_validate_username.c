...
void test_validate_my_username()
{
     ...
     */
    const char *usernameAutotest = my_username();
    const char *username1 = malloc_username_from_conf_file();
    //TEST_ASSERT_TRUE_MESSAGE(false,"AESD students, please fix me!");
    TEST_ASSERT_EQUAL_STRING_MESSAGE(usernameAutotest,username1,"varshini10798");
}
